/**
 * Extracts the content of a named `## Section` from a markdown string.
...
/**
 * Replaces or appends to a named `## Section` in a markdown string.
 * If the section doesn't exist, it is appended at the end of the document.
 */
...
/**
 * Removes the first line in a named `## Section` that contains `entrySubstring`.
 * No-ops if the section or the matching line is not found.
 */
